...
const OutfitStack: React.FC<OutfitStackProps> = ({ outfitHistory, onRemoveLastGarment, onSaveOutfit, isLoading }) => {
    ...
    <div className="flex flex-col">
       <div className="flex items-center justify-between border-b border-gray-400/50 pb-2 mb-3">
        ...
        <button
          ...
          className="flex items-center text-sm font-semibold text-gray-700 bg-gray-100/80 hover:bg-gray-200/80 px-3 py-1.5 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
